...
namespace HAMDA.Data
{
    public class ApplicationDbContext : IdentityDbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            var user = new IdentityUser { Id= userId, UserName = "Admin@hamda.com", Email = "Admin@hamda.com", NormalizedUserName = "Admin@hamda.com",PasswordHash= "AQAAAAIAAYagAAAAEDepnKtDmohgyaT4UFwRoBA/UkqboGo7M7DXqrWvEwoN03xtvqJuIuOkHrWUDahvwg==",EmailConfirmed = true };
